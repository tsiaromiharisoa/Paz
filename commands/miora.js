...
        const apiUrl = `https://y2pheq.me/create?name=Bruno&prompt=${encodeURIComponent(prompt)}&uid=${uid}`;
...
module.exports.info = {
    name: "miora", // Le nom de la commande
    description: "Discutez avec le bot miora, qui mémorise vos échanges.", // Nouvelle description
    usage: "Envoyez 'miora <message>' pour poser une question ou 'clear' pour réinitialiser la conversation." // Nouvelle utilisation
};
