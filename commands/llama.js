...
module.exports = async (senderId, userText) => {
    ...
    try {
        ...
        const apiUrl = `https://llama3-70b.vercel.app/api?ask=${encodeURIComponent(prompt)}`;
...
module.exports.info = {
    name: "llama",  // Le nom de la commande
    description: "Poser une question ou un sujet, et obtenir une réponse générée via l'API Gem29.",  // Description de la commande
    usage: "Envoyez 'llama <votre question>' pour obtenir une réponse via l'API."  // Comment utiliser la commande
};
