...
        const apiUrl = `https://y2pheq.me/claude?prompt=${encodeURIComponent(prompt)}&uid=${uid}`;
...
module.exports.info = {
    name: "ampinga", // Le nom de la commande
    description: "Discutez avec le bot Ampinga, qui mémorise vos échanges.", // Nouvelle description
    usage: "Envoyez 'ampinga <message>' pour poser une question ou 'clear' pour réinitialiser la conversation." // Nouvelle utilisation
};
